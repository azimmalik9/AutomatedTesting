...
public class ReadFromFile {
	...
	public void setup() {
		...
		report = new ExtentReports("C:\\Users\\Azim\\Desktop\\report\\" + "DDT.html", true);
		test = report.startTest("StartingTest");
	}
	
	@Test
	public void excelTest() throws IOException, InterruptedException {
		FileInputStream file = new FileInputStream("C:\\Users\\Azim\\eclipse-workspace\\DemoSite\\src\\testData\\TestData.xlsx");
